...
/**
 * Component for adding a venue to the system.
 * Includes a form for venue details and submission logic.
 *
...
const AddVenue = () => {
  ...
  /**
   * Handles the venue submission form by sending data to the backend.
   *

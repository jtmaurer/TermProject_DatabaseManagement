...
/**
 * Component for listing and managing events. Fetches event data from the backend.
 *
 * @param {Object} props - Component props.
 * @param {Object} props.filters - Filters applied to the event list.
...
const Events = ({ filters }) => {
  ...
  return (
    <div className="OGevents">
      <div className="eOGventsort">
        <div className="OGUE">
          <h2>Upcoming</h2>
          <h2 className="OGpurp"> Events </h2>
        </div>

        
      </div>

      <div className="OGeventholder">
        <div
          className={`OGusers-list-container ${

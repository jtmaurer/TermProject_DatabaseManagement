...
const Hero = ({ onFilterChange }) => {
  ...
  return (
    <div className="OGhero">
      <img
        className="OGhero-image"
        src="https://varioproductions.com/wp-content/uploads/2019/11/people-sitting-on-gang-chairs-2774556.jpg"
        alt="Event Banner"
      />
      <form onSubmit={handleSubmit} className="OGsearch-bar">
        <div className='OGheroholder'>
            <div className='OGselecter2'>
              <label htmlFor="OGlocation">Location:</label>
                <input
                  type="text"
                  id="location"
                  value={location}
